...
def _step_world():
    ...
    for h in sim.humans:
        ...
        h.visible = h.vision.scan(
            ...
            animals=sim.animals, partner=partner,
            fire_system=sim.fs,
    ...
    # Event log — flush buffer
    event_buffer.flush()

    # Snapshot — ทุก SAVE_INTERVAL_STEPS
